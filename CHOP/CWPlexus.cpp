...
DestroyCHOPInstance(CHOP_CPlusPlusBase* instance)
{
	...
	delete (CWPlexus*)instance;
}

};


CWPlexus::CWPlexus(const OP_NodeInfo* info) : myNodeInfo(info)
{
	myExecuteCount = 0;
	myOffset = 0.0;
}
...
void
CWPlexus::getGeneralInfo(CHOP_GeneralInfo* ginfo, const OP_Inputs* inputs, void* reserved1)
{
...
bool
CWPlexus::getOutputInfo(CHOP_OutputInfo* info, const OP_Inputs* inputs, void* reserved1)
{
...
void
CWPlexus::getChannelName(int32_t index, OP_String *name, const OP_Inputs* inputs, void* reserved1)
{
	name->setString("chan1");
}

void
CWPlexus::execute(CHOP_Output* output,
...
int32_t
CWPlexus::getNumInfoCHOPChans(void * reserved1)
{
...
void
CWPlexus::getInfoCHOPChan(int32_t index,
...
bool		
CWPlexus::getInfoDATSize(OP_InfoDATSize* infoSize, void* reserved1)
{
	infoSize->rows = 2;
	infoSize->cols = 2;
...
void
CWPlexus::getInfoDATEntries(int32_t index,
										int32_t nEntries,
...
void
CWPlexus::setupParameters(OP_ParameterManager* manager, void *reserved1)
{
	// speed
	{
...
void 
CWPlexus::pulsePressed(const char* name, void* reserved1)
{
